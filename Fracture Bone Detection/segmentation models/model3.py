...
class ResNet(nn.Module):
    def __init__(self):
        ...
        # Sigmoid activation
        self.sigmoid = nn.Sigmoid() # not required for t.nn.BCEWithLogitsLoss()
...
class ResNetWithSegmentation(nn.Module):
    def __init__(self, num_classes):
        ...
        # Upsample layer to match input size
    ...
    def forward(self, x):
        ...
        segmentation_output = self.upsample(segmentation_output)
